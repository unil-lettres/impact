        ...
        <div class="card-body">
            ...
            <table class="table">
                <thead>
                    <tr>
                        <th scope="col">
                            <a href="{{route('courses.configure', ['course' => $course, 'tag_order' => 'name', 'tag_direction' => $tagColumns['name']])}}" class="icon-link link-dark link-underline-opacity-0">
                                {{ trans("tags.name") }}
                                <i class="fa-solid fa-sort-{{['asc' => 'down', 'desc' => 'up'][$tagColumns['name']]}}"></i>
                            </a>
                        </th>
                        <th scope="col" class="text-end">
                            <a href="{{route('courses.configure', ['course' => $course, 'tag_order' => 'cards_count', 'tag_direction' => $tagColumns['cards_count']])}}" class="icon-link link-dark link-underline-opacity-0">
            ...
            <div class="row row-cols-lg-auto g-2 mt-1">
                <div class="col-12">
                    <button class="btn btn-primary w-100" type="button" data-bs-toggle="collapse" data-bs-target="#collapseCloneTags" aria-expanded="false" aria-controls="collapseCloneTags">
                ...
                <div class="col-12">
                    <div class="collapse" id="collapseCloneTags">
                        <div class="card card-body mt-1">
                            ...
                            <form method="post" action="{{ route('courses.clone.tags', [$course->id]) }}" class="row row-cols-md-auto g-2">
                                @method('POST')
                                @csrf
                                <div class="col-12 flex-fill">
