...
return [
    ...
    'mail.subject' => '[Impact] Invitation à la création d\'un compte',
    'mail.sent_by' => 'Invitation envoyée par',
    'mail.enrolled_in' => 'Espace dans lequel vous serez inscrit(e)',
    'mail.info' => 'Vous avez été invité à créer un compte sur <a href="http://wp.unil.ch/impact/" target="_blank">Impact</a>.',
    'mail.local.link' => 'Veuillez utiliser le lien ci-dessous afin de finaliser votre inscription.',
